...
<h2 class="hh">Tous les prooduits ci-dessous sont a acheter</h2>
    <div class="product-container">
        <?php
        $products = [
            ["appart 1", "Appart 1 a acheter", 150000, "appartement1.jpeg"],
            ["appart 2", "Appart 2 a acheter", 120000, "appartement2.jpeg"],
            ["appart 3", "Appart 3 a acheter", 200000, "appartement3.jpeg"],
            ["house 1", "Maison a acheter", 50000000, "appartement4.jpeg"],
            ["house 2", "Maison a acheter", 60000000, "appartement5.jpeg"],
            ["house 3", "Maison a acheter", 70000000, "appartement6.jpeg"]
        ];
